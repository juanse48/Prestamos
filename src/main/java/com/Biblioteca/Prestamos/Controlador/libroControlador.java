...
public class libroControlador {
   ...
   /* @GetMapping("/BuscarLibro/{id}")
    ...
    @PatchMapping("/ActualizarEditorial/{isbn}/{editorial}")
    public String actualizarEditorial(@PathVariable("isbn") String isbn, @PathVariable("editorial")String editorial){
